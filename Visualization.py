...
def exploratory_charts():
    ...
    st.header("2. Correlation between Duration and Rating")
    ...
    st.header("4. Top 10 Actors by Movie Count")
    ...
    st.header("5. Top 10 Movies by Weighted Rating")
